...
def vacancy1():
    return Vacancy(
        "Python-разработчик",
        "https://hh.ru/vacancy/120331701",
        None,
        "Опыт работы с <highlighttext>Python</highlighttext> от 1-го года. "
        "Опыт работы с фреймворками: FastApi, Flask, Django, Django REST.",
    )
